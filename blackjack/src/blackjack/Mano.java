 ...
 * @author Diana
 */
/* Con esta clase vamos a representar las cartas que tiene un jugador en cierta jugada y el dinero    que ha apostado en esa jugada */
import java.util.Vector;

public class Mano {

    // Se trata de un vector y no un array porque el numero de cartas en la mano es variable  
    private Vector mano;
    ...
    public int getBlackjackValor() {
        ...
        /* El as en principio vale 1, pero si al cambiar su valor por 11 conseguimos un resultado       igual a 21 o menor lo cambiaremos*/
